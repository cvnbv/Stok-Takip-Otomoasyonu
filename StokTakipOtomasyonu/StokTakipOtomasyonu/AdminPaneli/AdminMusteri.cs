...
namespace StokTakipOtomasyonu.AdminPaneli
{
    public partial class AdminMusteri : Form
    {
        ...
        public AdminMusteri(IKullaniciServices kullaniciServices)
        {
        ...
        {
            pictureBox_musteri.Image = Image.FromFile(@"..\..\Resimler\user1.png");
            MusteriListele();

            if (UserDetailBus.RolID == 3) //Giriş yapan personel ise Rol ve Onay gözükmücek onda
            {
        ...
        {
            dataGridView1.DataSource = _kullaniciServices.GetAllMusteri();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                pictureBox_musteri.Image = Image.FromFile(dataGridView1.Rows[e.RowIndex].Cells[8].Value.ToString());
            }
        ...
        private void button_guncelle_Click(object sender, EventArgs e)
        {
            ...
            var result = MessageBox.Show("Müşteriyi güncellemek istediğinize emin misiniz?", "Personel Güncelleme", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        ...
        {
            var result = MessageBox.Show("Müşteriyi Silmek istediğinize emin misiniz?", "Personel Silme", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
